...
tags:
  ...
  - fondements
date: 2026-06-18
auteurs_principaux: "Dweck · Elliot"
---

# 🧩 Mastery orientation · Entity theory

> Ce fondement documente le deuxième des trois traits de la configuration motivationnelle.
> → Lire aussi : [[08 — Need for Cognition]] · [[10 — Agon · Alea · Mimicry · Ilinx]]
> → Configuration complète : [[L2 - Schémas Cognitifs/11 — Mobilisation compensatoire -- Suramplification]]
> → Comment ces concepts pré-conditionnent les L2 : [[02 — Connexions & Imbrications]]

> [!success] ✅ Fondement scientifiquement établi
> Mastery orientation / Entity theory (Dweck, 1986) est un construit psychologique empiriquement validé — 40+ ans de recherche, réplication cross-culturelle, bien que les applications pratiques soient plus nuancées que les versions populaires.

---

## I. Positionnement dans l'Inner Mapping
...
## II. Fixed mindset / Growth mindset — la version populaire

> [!todo] 💡 Si tu connais ces termes via Alexis ou la littérature grand public
> Dweck a popularisé ces concepts sous les termes **"fixed mindset"** et **"growth mindset"** dans *Mindset* (2006). C'est le même construit — deux habillages différents.
>
> | Terme populaire | Terme académique |
> |---|---|
> | Fixed mindset | Entity theory · Performance orientation |
> | Growth mindset | Incremental theory · Mastery orientation |
>
> **Pourquoi cette fiche utilise la version académique :**
> La version grand public fusionne deux niveaux distincts que Dweck elle-même sépare : la *croyance sur l'intelligence* (fixe ou malléable ?) et l'*orientation vers les buts* (maîtrise ou performance ?). On peut croire l'intelligence malléable ET être motivé par l'évitement de l'échec — la case **mastery-avoidance** (§V) ne rentre ni dans "fixed" ni dans "growth".
>
> La version académique cartographie mieux ce qui se passe dans le vault : la **Résultats-dépendance** est une manifestation de la performance orientation. L'**Intransigeance envers soi** est une performance orientation retournée contre soi.
...
## IV. Les deux orientations complètes

**Orientation Performance (entity theory — intelligence fixe) :**

| Dimension | Comportement | Exemple poker |
|---|---|---|
| Vision de la compétence | Fixe — prouvée ou non. L'objectif est de paraître compétent | Éviter les spots difficiles où on pourrait "paraître nul" |
...
| Dimension | Comportement | Exemple poker |
|---|---|---|
| Vision de la compétence | Malléable — se développe par l'effort et la stratégie | Chaque session est du matériau pour progresser |
| Réponse à l'adversité | Informationnelle — l'échec est du feedback, pas un verdict | Session perdante = "qu'est-ce que j'apprends là ?" |
| Après l'échec | Maintien ou augmentation de la motivation, analyse | Revue froide sans effondrement identitaire |
| Face au défi | Recherche les tâches difficiles | Engagement accru dans les spots complexes |
| Réaction aux erreurs | Curiosité et ajustement | [[Fondements théoriques/07 — Self-compassion\|Self-compassion]] — dissociation erreur/valeur |

---

## V. Le modèle 2×2 d'Elliot (1999) — la nuance que fixed/growth rate

> [!todo] Elliot a montré que mastery et performance ne sont pas mutuellement exclusives — le même individu peut combiner les deux selon le contexte.

| | **Approche** | **Évitement** |
|---|---|---|
| **Mastery** | Maîtriser · progresser · chercher le défi | Ne pas stagner · peur de ne pas progresser |
| **Performance** | Paraître compétent · surpasser | Éviter de paraître incompétent |

**Application directe :**
Le pattern observé en session suggère une **mastery-approach** dominante (engagement accru sur les spots difficiles) coexistant avec des éléments de **performance-avoidance** dans des contextes spécifiques (le [[L2 - Schémas Cognitifs/06 — Évaluation de l'enjeu -- Piédestal\|Piédestal]] en haute énergie = "je ne peux pas gâcher ça").
...
## VI. Contradictions et limites

> [!warning] ⚠️ Trois points à nuancer

**1. Les interventions "growth mindset" ont eu des résultats mitigés**
Si le construit théorique est solide, les applications pratiques en éducation ont produit des effets inconsistants dans les méta-analyses. "Changer la croyance change les résultats" est plus complexe que les versions populaires ne le laissent entendre.

**2. La distinction n'est pas tranchée**
La même personne peut avoir une théorie incrémentale pour ses compétences cognitives et une théorie de l'entité pour ses compétences émotionnelles. Contexte et domaine modifient l'orientation.

**3. Les effets mastery peuvent s'inverser sous pression extrême**
Même les individus mastery-orientés peuvent basculer vers des réponses performance-orientées quand les enjeux deviennent très élevés — interaction avec l'intensité du BIS.
...
## VIII. Solidité scientifique

| Concept | Solidité | Note |
|---|---|---|
...
- Wood, R. & Bandura, A. (1989). *Impact of conceptions of ability on self-regulatory mechanisms.* Journal of Personality and Social Psychology, 56(3), 407–415.

## Notes liées
- [[08 — Need for Cognition]] · [[10 — Agon · Alea · Mimicry · Ilinx]]
